...
syn match tppAbstractOptionKey contained "^--\%(author\|title\|date\|header\|footer\) *" nextgroup=tppString
...
syn region tppAbstractOption start="^--\%(author\|title\|date\|header\|footer\)" end="$" contains=tppAbstractOptionKey oneline
