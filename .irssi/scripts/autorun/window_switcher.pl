...
# The last script I am going to list is Window Switcher. As I said, I auto join more than 40 channels. When you have that many windows open, it isn’t as easy to switch between
# them. You have 1-0 which is as easy as just Alt+#, and then Q-O (most of the top row of letters on your keyboard), which is as easy as Alt+Letter. But when you get to window
# #20, it looses its easiness. You now have to type /window 20 to switch to window number 20.. Not as easy is it? A whole lot more keys to push. Enter Window Switcher. Window
# switcher takes the /window and converts it to /ws.. That removes 4 keys from what you have to type.. Here is one better.. It allows you to bind a key combination (Ctrl + G) and
# then you just type the window number. So Ctrl+G 20 will now switch you to window 20. Quite a nice script which has saved me a lot of time changing windows!
