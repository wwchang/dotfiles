...
-- [ functions ] {{{
    ...
    -- {{{ executing commands and scripts and output to widget
...
tags = {
    ...
    layout = { layouts[5], layouts[2], layouts[5], -- tags: 1, 2, 3
               ...
               layouts[2], layouts[12], layouts[5]   --       7, 8, 9
            }
}
...
-- weather {{{
    ...
    vicious.register(
        ...
        function (widget, args)
            ...
            return " weather: " .. args["{city}"] .. " > " .. args["{tempc}"] .. "°C"
        end,
        3600, "ZSHC"
    )
...
-- Mail {{{
    ...
    vicious.register(
        ...
        { ["INBOX"]="Inbox", ["unsure"]="unsure", ["QQ"]="QQ" },
        300, mdir
        )
