...
table5={
    ...
    --["v"]={"urxvt -name wiki -e sh -c 'vim +VimwikiIndex'","wiki"},
    --["u"]={"urxvt -name night -e -sh -c 'vim ~/.vim/vimwiki/tasks.wiki'","night"}, 
    --["b"]={"urxvt -name now -e -sh -c 'vim +BlogNew'","now"},
    --["w"]={"chromium-browser","Chromium-browser"}, 
